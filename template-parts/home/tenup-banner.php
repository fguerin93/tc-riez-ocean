...
<div style="background:#F5EDD6; border-top:1px solid rgba(230,51,41,.25); border-bottom:1px solid rgba(230,51,41,.25);">
	<div class="max-w-[1520px] mx-auto px-5 sm:px-8 md:px-16 py-6 flex flex-col sm:flex-row items-center justify-between gap-4">
		<div class="flex items-center gap-4">
			...
			<div>
				<p class="text-ink font-display font-semibold text-sm"><?php echo esc_html( $titre ); ?></p>
				<p class="text-ink/50 text-xs mt-0.5"><?php echo esc_html( $sous ); ?></p>
			</div>
		</div>
		<?php if ( ! empty( $links ) ) : ?>
