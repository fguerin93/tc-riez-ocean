...
add_action( 'wp_enqueue_scripts', function () {
	...
	wp_enqueue_style(
		'tcro-fonts',
		'https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,600;0,700;0,800;0,900;1,700&family=Cormorant+Garamond:ital,wght@0,300;0,400;1,300;1,400&family=DM+Sans:wght@300;400;500;600&display=swap',
		[],
		null
	);
